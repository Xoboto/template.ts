...
const employeeTableBinder = new TemplateBinder('#employee-table', employeeTableState);
employeeTableBinder.bind();
...
const productTableBinder = new TemplateBinder('#product-table', productTableState);
productTableBinder.bind();

// Example: Simple users table with minimal features
const simpleUserTableState = {
  columns: [
...
const simpleUserTableBinder = new TemplateBinder('#simple-user-table', simpleUserTableState);
simpleUserTableBinder.bind();
...
const emptyTableState = {
  ...
  data: [],
  emptyMessage: 'No records found. Please add some data.'
};

const emptyTableBinder = new TemplateBinder('#empty-table', emptyTableState);
emptyTableBinder.bind();
